"""From SceneGraphLoc: https://github.com/y9miao/VLSG.

DinoV2 feature extractor that hooks an intermediate transformer block and returns the
per-patch descriptors. Shared by the 2D feature and object visual embedding generators.
"""
